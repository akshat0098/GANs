# -*- coding: utf-8 -*-
"""GANs-pytorch-MNIST.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ecxN2Z53ajRMmIimsrXd_hx2EygsisEK
"""
...
for epoch in range(num_epochs):
  for id,(training_sample,_) in enumerate(loader):
    ...
    lossG = criterion(lossD_fakeSample,torch.ones_like(lossD_fakeSample)) # we are trying to maximize
    generator.zero_grad()
    lossG.backward()
    opt_generator.step()
